...
func TestCompactMergesIncludesSourceRowTotals(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case strings.Contains(query, "FROM system.merges"):
			...
			_, _ = io.WriteString(w, `{"partition_id":"202607","result_part_name":"all_1_2_1","elapsed":2.5,"progress":0.4,"num_parts":2,"source_part_names":["all_1_1_0","all_2_2_0"],"rows_read":40,"bytes_read_uncompressed":400,"total_size_bytes_uncompressed":1000}`+"\n")
	...
	merge := merges[0]
	if merge.PartitionID != "202607" || merge.ResultPartName != "all_1_2_1" || merge.Progress != 0.4 || merge.SourceParts != 2 || merge.RowsRead != 40 || merge.RowsTotal != 100 || merge.BytesRead != 400 || merge.BytesTotal != 1000 {
